...
# API Configuration
API_TOKEN = getattr(sys.modules.get('config'), 'NUB_YTDLP_API_KEY', os.getenv('NUB_YTDLP_API_KEY', os.getenv('NUBYTDLP_API', '')))
BASE_URL = getattr(sys.modules.get('config'), 'NUB_YTDLP_BASE_URL', os.getenv('NUB_YTDLP_BASE_URL', os.getenv('YTDLP_BASE_URL', 'http://api.nubcoders.com')))
